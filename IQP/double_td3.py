...
class PolicyNetwork(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(11, 128) # Input : State 3
...
env      = gym.make("InvertedDoublePendulum-v4", render_mode = 'human', model_path=xml_file)
...
plt.plot(X, Y)
plt.savefig('./TD3_test3.png')

Y = np.array(Y)
np.save('./TD3_check3_X', X)
np.save('./TD3_check3_Y', Y)
